...
async function main() {
  ...
  const products = [
    ...
    { id: 26, name: 'Cooking Oil 1L', category: 'Cooking', price: 6500 },
    { id: 27, name: 'Salt 500g', category: 'Cooking', price: 1200 },
    { id: 28, name: 'Flour 1kg', category: 'Cooking', price: 2800 },
    { id: 29, name: 'Butter 200g', category: 'Dairy', price: 5500 },
    { id: 30, name: 'Garlic 200g', category: 'Vegetables', price: 2200 },
    { id: 31, name: 'Tomato 1kg', category: 'Vegetables', price: 4500 },
    { id: 32, name: 'Ketchup 500ml', category: 'Sauce', price: 4800 },
    { id: 33, name: 'Soy Sauce 250ml', category: 'Sauce', price: 3200 },
    { id: 34, name: 'Frozen French Fries 1kg', category: 'Frozen', price: 8500 },
    { id: 35, name: 'Cheese Slice (10pcs)', category: 'Dairy', price: 7200 },
    { id: 36, name: 'Noodles (Goimin) 500g', category: 'Cooking', price: 2200 },
    { id: 37, name: 'Carrot 1kg', category: 'Vegetables', price: 2000 },
    { id: 38, name: 'Cabbage 1kg', category: 'Vegetables', price: 1800 },
    { id: 39, name: 'Bell Pepper 500g', category: 'Vegetables', price: 4500 },
    { id: 40, name: 'Mutton 1kg', category: 'Meat', price: 16000 },
    { id: 41, name: 'Frozen Buuz (20pcs)', category: 'Frozen', price: 12000 },
    { id: 42, name: 'Frozen Bansh (30pcs)', category: 'Frozen', price: 10500 },
    { id: 43, name: 'Frozen Khuushuur (10pcs)', category: 'Frozen', price: 11000 },
  ];
